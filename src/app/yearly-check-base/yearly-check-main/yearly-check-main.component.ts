...
@Component({
  selector: 'app-yearly-check-main',
  templateUrl: './yearly-check-main.component.html',
  styleUrls: ['./yearly-check-main.component.css']
})

//Normal
export class YearlyCheckMainComponent implements OnInit {
  ...
  constructor(private datas: YearlyCheckService) {
  ...
  calculatePoints() {
    ...
    this.datas.setResultEachDay2({ date: this.MB.date, ProfitAndLoss: this.customParseFloat(this.totalPointsEarned), noOfTrades: this.trades.length })
...
//             this.trades.push({ side: 'SELL', exec: this.MB.priceToTrade, isLast: false })
//             this.tradeCount++;
//             if (this.tradeCount == 3) this.finishTrade = true
//             return
//             //update bands and convert to normal order
//             //new high >  old high
//           }
